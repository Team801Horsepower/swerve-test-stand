...
public class TurnMotor {
  ...
  public TurnMotor(int motorID, int motorIndex) {
    ...
    sparkEncoder = sparkMotor.getEncoder(SparkMaxRelativeEncoder.Type.kHallSensor, 42);
    // sparkEncoder = sparkMotor.getEncoder(SparkMaxRelativeEncoder.Type.kQuadrature, 4096 * 6);
    // sparkEncoder = sparkMotor.getEncoder(SparkMaxRelativeEncoder.Type.kQuadrature, 8192 * 6);
